 ...
 * @param UARTx :UARTx外设
 *        参数可以是:
 *           CW_UART1、CW_UART2、CW_UART3、CW_UART4、CW_UART5、CW_UART6
 * @param Data :待发送的数据
 */
...
{
    CW_SYSCTRL->APBRST1_f.UART4 = 0;
    CW_SYSCTRL->APBRST1_f.UART4 = 1;
}
...
{
    CW_SYSCTRL->APBRST1_f.UART5 = 0;
    CW_SYSCTRL->APBRST1_f.UART5 = 1;
}
...
{
    CW_SYSCTRL->APBRST2_f.UART6 = 0;
    CW_SYSCTRL->APBRST2_f.UART6 = 1;
}
