...
__Vectors                       
                ...
                DCD     GPIOE_GPIOF_IRQHandler    ;< 8 GPIOE And GPIOF Interrupt Handler
                ...
                DCD     BTIM2_LPTIM1_IRQHandler   ;< 21 BTIM2 And LPTIM1 Interrupt Handler
                ...
                DCD     UART1_UART4_IRQHandler    ;< 27 UART1 And UART4 Interrupt Handler
                DCD     UART2_UART5_IRQHandler    ;< 28 UART2 And UART5 Interrupt Handler
                DCD     UART3_UART6_IRQHandler    ;< 29 UART3 And UART6 Interrupt Handler
...
Default_Handler PROC
                ...
                EXPORT  GPIOE_GPIOF_IRQHandler   [WEAK]
                ...
                EXPORT  BTIM2_LPTIM1_IRQHandler  [WEAK]
                EXPORT  BTIM3_IRQHandler         [WEAK]
                EXPORT  I2C1_IRQHandler          [WEAK]
                EXPORT  I2C2_IRQHandler          [WEAK]
                EXPORT  SPI1_IRQHandler          [WEAK]
                EXPORT  SPI2_IRQHandler          [WEAK]
                EXPORT  UART1_UART4_IRQHandler   [WEAK]
                EXPORT  UART2_UART5_IRQHandler   [WEAK]
                EXPORT  UART3_UART6_IRQHandler   [WEAK]
...
GTIM4_IRQHandler
BTIM1_IRQHandler
BTIM2_LPTIM1_IRQHandler
BTIM3_IRQHandler
I2C1_IRQHandler
I2C2_IRQHandler
SPI1_IRQHandler
SPI2_IRQHandler
UART1_UART4_IRQHandler
UART2_UART5_IRQHandler
UART3_UART6_IRQHandler
